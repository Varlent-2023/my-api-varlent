...
function getData(){
    ...
    .then(function (response) {
        ...
        (response.data.products).forEach((item) => {
            template += `
            <div class="single-hero-slider-7" onclick="location.href='`+baseUrl+`/bakery/`+item.id+`'">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-content-wrap">
                                <div class="hero-text-7 mt-lg-5">
                                    <h6 class="mb-20">
                                        Latest from Rotilicius
                                    </h6>
                                    <h1>`+breakWord(item.product_name)+`</h1>
                                ...
                                <div class="inner-images">
                                    <div class="image-one">
                                        <img src="`+item.images+`" width="250" class="img-fluid" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>
